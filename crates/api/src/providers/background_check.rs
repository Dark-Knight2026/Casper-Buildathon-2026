...
//! [`FakeBackgroundCheckProvider`] that auto-clears every check, used for the
//! hackathon. Production deployments swap in a real bureau (TransUnion,
...
/// Hackathon implementation that auto-clears every check synchronously.
///
