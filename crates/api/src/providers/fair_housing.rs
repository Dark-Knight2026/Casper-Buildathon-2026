...
//! that flags a minimal technical blocklist of protected-class phrases, used
//! for the hackathon. Production deployments swap in the official CO/GC ruleset
...
/// Hackathon implementation that flags the [`BLOCKED_PHRASES`] technical
/// blocklist.
///
