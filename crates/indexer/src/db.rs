//! Database access layer for the indexer.
//!
//! All SQL queries are centralized here so that the rest of the crate
//! (processor, backfill, streaming) stays free of raw SQL.
//!
//! Uses [`sqlx::query!`] macros for compile-time SQL validation.
//!
//! ## Sections
//!
//! - **Cursors** — resume-from-last-position helpers (`event_cursors`).
