...
|                             | [Structuring: Centralized Workspace Dependency Manifest](#imports--modules--structuring-centralized-workspace-dependency-manifest)                           | All dependency definitions (version, source) MUST reside in the root `Cargo.toml`; crates MUST inherit them.      |
