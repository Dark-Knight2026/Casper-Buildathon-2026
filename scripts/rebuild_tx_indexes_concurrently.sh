...
psql "$DATABASE_URL" -c "DROP INDEX CONCURRENTLY IF EXISTS idx_blockchain_tx_from_address;"
psql "$DATABASE_URL" -c "DROP INDEX CONCURRENTLY IF EXISTS idx_blockchain_tx_to_address;"
psql "$DATABASE_URL" -c "DROP INDEX CONCURRENTLY IF EXISTS idx_blockchain_tx_contract_hash;"
