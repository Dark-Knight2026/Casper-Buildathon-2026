...
mod tests {
    ...
    impl Clone for TailorCoinInitArgs {
        fn clone(&self) -> Self {
            Self {
    ...
    fn setup(
        ...
        let tailor_coin_init_args = TailorCoinInitArgs {
        ...
        let tailor_coin = TailorCoin::deploy(env, tailor_coin_init_args.clone());
        let mock_cep18 = TailorCoin::deploy(env, tailor_coin_init_args);
