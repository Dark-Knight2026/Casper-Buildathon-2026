...
//! that treats the landlord's submitted commit params as consistent. A real CSPR RPC reader (querying the `Lease` and `Escrow`
...
/// Stub implementation that treats the submitted commit params as
/// consistent.
///
