...
import { UserPlus, X, Plus, MapPin, Award, DollarSign } from 'lucide-react';

interface AddAgentModalProps {
  trigger?: React.ReactNode;
}

export default function AddAgentModal({ trigger }: AddAgentModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${formData.name} has been added to your brokerage.`,
      });
