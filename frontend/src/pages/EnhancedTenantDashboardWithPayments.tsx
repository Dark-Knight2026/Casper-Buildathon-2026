...
import PaymentScheduler from '@/components/tenant/payment/PaymentScheduler';
import PaymentAnalytics from '@/components/tenant/payment/PaymentAnalytics';
import RealTimePaymentStatus from '@/components/tenant/payment/RealTimePaymentStatus';
...
export default function EnhancedTenantDashboardWithPayments() {
  const { user } = useAuth();
  const {
    lease,
    dashboardStats,
  ...
  useEffect(() => {
    ...
    const isNewTenant = !onboardingComplete;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Welcome back, {user?.name || 'Tenant'}! Manage your payments and rental account.
              </p>
            </div>
