    ...
    const loadData = async () => {
      ...
      try {
        const [sum, deds, docs, evts] = await Promise.all([
          ...
          taxService.getTaxDeductions('buyer_123'),
          taxService.getTaxDocuments('buyer_123'),
        ...
        console.error('Failed to load buyer tax data', error);
      } finally {
        setLoading(false);
      }
    };
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <TaxSummaryCard summary={summary} isLoading={loading} role="Buyer" />
